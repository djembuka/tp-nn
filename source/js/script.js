...
$(document)
  ...
  .delegate('#process .b-photo-card', 'touchend', function (e) {
    if (
      e.changedTouches[0].pageX !== window.processFotoramaTouch.pageX ||
      e.changedTouches[0].pageY !== window.processFotoramaTouch.pageY
    ) {
      return false;
    }
...
function clickPhotoCard(e, $photoCard) {
  ...
  $.ajax({
    ...
    success: function (html) {
      ...
      //fotorama arrows
      setTimeout(function () {
        $('#processLayer .fotorama__wrap--toggle-arrows').addClass(
